...
import com.labz04.omri.uwimaps.dataprovider.Rest_Data_Provider;
...
public class RestFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        faculty_category = Rest_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_restaurant, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_rest);
