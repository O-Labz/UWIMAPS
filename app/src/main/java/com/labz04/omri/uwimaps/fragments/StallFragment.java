...
import com.labz04.omri.uwimaps.dataprovider.Stalls_Data_Provider;
...
public class StallFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        faculty_category = Stalls_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_stalls, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_stall);
