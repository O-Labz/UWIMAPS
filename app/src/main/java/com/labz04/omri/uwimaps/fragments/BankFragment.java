...
import com.labz04.omri.uwimaps.dataprovider.Banks_Data_Provider;
...
public class BankFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        faculty_category = Banks_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_bank, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_g);
...
//                }
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                //dne variable is used by the shortest path class so that the
                dne = child_name;
