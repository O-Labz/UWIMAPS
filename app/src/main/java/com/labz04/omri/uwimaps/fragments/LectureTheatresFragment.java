...
import com.labz04.omri.uwimaps.dataprovider.Lecture_Theatres_Data_Provider;
 ...
 */
public class LectureTheatresFragment extends Fragment
{
    ...
    public LectureTheatresFragment(){}

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        faculty_category = Lecture_Theatres_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_lect, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_lect);
