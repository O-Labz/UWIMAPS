...
import com.labz04.omri.uwimaps.dataprovider.Libraries_Data_Provider;
...
public class LibrariesFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        faculty_category = Libraries_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_lib, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_lib);
