...
import com.labz04.omri.uwimaps.dataprovider.Hum_Data_Provider;
...
public class HumFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        faculty_category = Hum_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_hummanities, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_hum);
