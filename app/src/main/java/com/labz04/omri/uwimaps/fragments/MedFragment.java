...
import com.labz04.omri.uwimaps.dataprovider.Med_Data_Provider;
...
public class MedFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        faculty_category = Med_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_med, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_med);
