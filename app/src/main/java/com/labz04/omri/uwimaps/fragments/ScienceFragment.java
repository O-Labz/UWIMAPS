...
import com.labz04.omri.uwimaps.dataprovider.Data_provider;
...
public class ScienceFragment extends Fragment
{
    ...
    {
        faculty_category = Data_provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_science, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list);
