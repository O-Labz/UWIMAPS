...
import com.labz04.omri.uwimaps.dataprovider.Buildings_Data_Provider;
...
public class BuildingsFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState)
    {
        ...
        faculty_category = Buildings_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_build, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_build);
