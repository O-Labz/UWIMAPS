...
import com.labz04.omri.uwimaps.dataprovider.Soci_Data_Provider;
...
public class SocialFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        faculty_category = Soci_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_social, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_soci);
