...
import com.labz04.omri.uwimaps.dataprovider.Gazebo_Data_Provider;
...
public class GazFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        faculty_category = Gazebo_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_gazebo, container, false);
