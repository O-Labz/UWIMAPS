...
import com.labz04.omri.uwimaps.dataprovider.Law_Data_Provider;
...
public class LawFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        faculty_category = Law_Data_Provider.get_info();
        ...
        View row = inflater.inflate(R.layout.fragment_law, container, false);
        ExpandableListView Exp_list = (ExpandableListView) row.findViewById(R.id.exp_list_law);
